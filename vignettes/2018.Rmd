...
vignette: >
  %\VignetteIndexEntry{Scorer 2018}
...
selected_url <- as.character(fvbb.scorer:::saisonmanager_urls()["2018"])
...
jsonlite::write_json(games_stats_list_played_only,path = "2019.json")
